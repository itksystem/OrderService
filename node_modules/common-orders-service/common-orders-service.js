...
const SQL = {
  ORDER: {
    CREATE: `INSERT INTO pa_orders_service.orders (user_id, reference_id) VALUES ($1, $2)`,
    FIND_BY_USER_AND_REFERENCE: `SELECT * FROM pa_orders_service.orders WHERE user_id = $1 AND reference_id = $2`,
    FIND_BY_USER: `SELECT order_id, status, created_at, updated_at FROM pa_orders_service.orders WHERE user_id = $1`,
